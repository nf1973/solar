...
const Header = () => {
  return (
    <div className="flex items-center justify-between w-full">
      <div>
        <h2 className="text-xl lg:text-3xl font-bold text-teal-600">
          Solar Analysis
        </h2>
        <p className="text-xs lg:text-sm italic text-teal-600">
          Harnessing Sunlight, Illuminating Insights
        </p>
      </div>
      <div className="flex items-center justify-end w-2/3 gap-8 font-semibold text-sm lg:text-base text-teal-600 ">
